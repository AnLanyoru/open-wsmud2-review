...
this.set_drop({
    ...
    obj: ["book/bc#hujiadaofa", "book/bc#sixiangbu", "book/bc#lengyueshengong", "eq/lv2/cw_baodao"],
    odds: 3500
});
this.set_chat_msg([
    "胡斐沉声说道：杀父之仇，不共戴天。",
    "胡斐按着刀柄说道：阎基若在关外，我一定要亲手了结他。",
    "胡斐说道：我胡家宝刀与四十二章经中的地图，都和闯王宝藏有些关联。"
]);
this.on_accept = function (me, obj, count) {
    ...
    if (obj.is("sp/bj/yanji")) {
        ...
        me.notify("<HIC>胡斐说道：若你还想探闯王宝藏，须留意四十二章经里的龙脉地图。</hic>");
        me.set_temp("fb/guanwai/hu", 1);
        me.add_fbscore(20, 100);
        return true;
    }
}
