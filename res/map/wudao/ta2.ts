...
this.on_before_enter = function (me) {
    var level = (me.query_temp("wd_level", 0)) + 1 - 99;
...
this.on_die1 = function (me) {
    ...
    this.hp = this.max_hp;
    this.mp = this.max_mp;
    var npc = this.environment.find_by_path("pub/wudao_boss");
    npc && npc.destroy();
...
this.on_leave = function (me, dir) {
    ...
    if (dir == "up") {
        ...
        if (me.query_temp('wd_level', 0) >= 104) {
            return me.notify_fail('更高层暂未开放。');
        }
        me.moveto('wudao/ta2');
